    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/develop_v4jq/devdiary/se2/sample/photo_uploader/file_uploader_html5.jsp'; 	//upload URL
    	console.log("html5Upload() 호출");    
    	//파일을 하나씩 보내고, 결과를 받음.
    ...
    function callAjaxForHTML5 (tempFile, sUploadURL){ 
      console.log("callAjaxForHTML5() 호출");
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 		  ...
 		  sUrl  : '/se2/sample/photo_uploader/file_uploader.jsp',	//샘플 URL입니다.
